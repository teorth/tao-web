...
Strictly speaking, conclusion (v) of the above theorem does not appear explicitly in \cite{maynard-new}, but follows easily from the methods of that paper.  For a survey of these recent developments, see \cite{granville}.
...
denote the primitive congruence classes of $\Z/q\Z$.  
