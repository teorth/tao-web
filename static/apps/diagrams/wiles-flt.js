...
;(function (g) {
  var D = {
    ...
    nodes: [
      { id: "def:deformation", kind: "definition", label: "Ch. 1", name: "Galois deformation ring R_D", section: "1", weight: 4, statement: "Mazur's deformation theory: the lifts of a residual representation ρ₀: Gal(Q_Σ/Q) → GL₂(k) of a fixed type D are represented by a universal deformation ring R_D.", plain: "A single ring R_D that parametrises all Galois representations reducing to ρ₀ and satisfying the chosen local conditions." },
      { id: "def:selmer", kind: "definition", label: "(1.6)", name: "Selmer group H¹_D", section: "1", weight: 3, statement: "A Selmer group H¹_D(Q_Σ/Q, V) cutting out deformations of type D by local conditions at p and at the ramified primes." },
      { id: "prop:1.2", kind: "proposition", label: "Prop 1.2", name: "Cotangent space = Selmer group", section: "1", weight: 3, statement: "The reduced cotangent space of R_D is a Selmer group: Hom(p_D/p_D², K/O) ≅ H¹_D(Q_Σ/Q, V)." },
      { id: "prop:1.6", kind: "proposition", label: "Prop 1.6", name: "Selmer order formula (Poitou–Tate)", section: "1", weight: 3, statement: "A Greenberg–Wiles formula from Poitou–Tate duality relating the orders of dual Selmer groups as the ramification set varies." },
      { id: "lem:1.10", kind: "lemma", label: "Lem 1.10", name: "Group theory of im ρ₀ / special primes", section: "1", weight: 2, statement: "Group-theoretic facts about im ρ₀ producing the auxiliary primes q (with q ≡ 1 mod p and ρ₀(Frob q) having distinct eigenvalues) used to bound the Selmer group." },
      ...
      { id: "thm:2.1", kind: "theorem", label: "Thm 2.1", name: "Hecke rings are Gorenstein (multiplicity one)", section: "2", weight: 3, statement: "Mazur's multiplicity-one theorem: the Hecke ring localised at a maximal ideal is Gorenstein, so it carries a perfect self-duality." },
      { id: "def:hecke", kind: "definition", label: "Ch. 2", name: "Hecke ring T_D", section: "2", weight: 3, statement: "The Hecke ring T_D acting on modular forms, carrying a Galois representation with trace(Frob q) = T_q." },
      { id: "def:eta", kind: "definition", label: "Ch. 2 §2", name: "Congruence invariant η", section: "2", weight: 3, statement: "The invariant η measuring congruences between the eigenform f and other modular forms, defined through the Gorenstein self-duality of T_D." },
      { id: "map:phi", kind: "proposition", label: "φ_D", name: "The map R_D → T_D", section: "2", weight: 4, statement: "A canonical surjection φ_D: R_D → T_D taking the universal deformation to the Galois representation carried by the Hecke ring." },
      { id: "app:ci", kind: "theorem", label: "Appendix", name: "Complete-intersection criterion", section: "A", weight: 3, statement: "Commutative algebra: a Gorenstein O-algebra is a complete intersection exactly when its η-invariant equals its p/p²-invariant; the two are compared through Fitting ideals." },
      { id: "thm:2.17", kind: "theorem", label: "Thm 2.17", name: "Numerical criterion for R = T", section: "2", weight: 4, statement: "If #(O/η) ≥ #(p_R/p_R²) then φ_D is an isomorphism and T_D is a complete intersection." },
      ...
      { id: "thm:3.1", kind: "theorem", label: "Thm 3.1", name: "Selmer bound at minimal level", section: "3", weight: 4, statement: "At minimal level the Selmer group is bounded by #(p_T/p_T²)·c_p; with the complete-intersection input this bound is an equality." },
      ...
      { id: "thm:0.3", kind: "theorem", label: "Thm 0.3", name: "3-adic modularity of E", section: "0", weight: 4, statement: "If E/Q has good or multiplicative reduction at 3 and irreducible mod-3 representation, then E is modular." },
      { id: "thm:35", kind: "proposition", label: "Thm 5.2", name: "The 3–5 switch", section: "5", weight: 4, statement: "When the mod-3 representation of E is reducible, exhibit an auxiliary elliptic curve sharing E's mod-5 representation and modular by the mod-3 argument; this forces the mod-5 representation of E to be modular." },
      ...
      { id: "thm:0.4", kind: "theorem", label: "Thm 0.4", name: "Semistable elliptic curves are modular", section: "0", weight: 5, statement: "Every semistable elliptic curve over Q is modular.", plain: "The main theorem of the paper." },
      { id: "thm:0.5", kind: "theorem", label: "Thm 0.5", name: "Fermat's Last Theorem", section: "0", weight: 5, statement: "There are no nonzero integers a, b, c with aⁿ + bⁿ = cⁿ for any integer n > 2.", plain: "The 350-year-old conjecture, obtained as a corollary." }
    ],
    edges: [
